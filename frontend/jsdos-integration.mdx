...
sidebarTitle: 3.2. Integración js-dos
...
Con js-dos integrado, el siguiente paso es implementar la [Arquitectura Frontend](/frontend/overview) que maneje la interfaz de usuario y las interacciones del jugador.