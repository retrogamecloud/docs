...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: frontend
          image: retrogamehub/frontend:sha-2fbfb66
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: kong
          # Imagen de Kong desde DockerHub - v1.0.18 (sha-316a3d2)
          image: retrogamehub/kong:sha-316a3d2
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: backend
        image: retrogamehub/backend:sha-f1f9b35  # Will be updated by CI/CD
        imagePullPolicy: IfNotPresent
        ports:
        - containerPort: 3000
          name: http
    ...
    spec:
      containers:
        - name: backend
          ...
          image: retrogamehub/backend:sha-f1f9b35
          # La imagen se descarga solo si no existe localmente (mejor práctica)
          imagePullPolicy: IfNotPresent
          ports:
            - containerPort: 3000
