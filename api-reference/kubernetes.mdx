...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: frontend
          image: retrogamehub/frontend:sha-37e5483
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: kong
          # Imagen de Kong desde DockerHub - v1.0.11 (sha-fdf119b)
          image: retrogamehub/kong:sha-fdf119b
    ...
    spec:
      containers:
        - name: backend
          ...
          image: retrogamehub/backend:sha-9cb11ba
          # La imagen se descarga solo si no existe localmente (mejor práctica)
          imagePullPolicy: IfNotPresent
          ports:
            - containerPort: 3000
