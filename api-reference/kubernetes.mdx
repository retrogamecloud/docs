...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: frontend
          image: retrogamehub/frontend:sha-8bc1b67
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: kong
          # Imagen de Kong desde DockerHub - v1.0.14 (sha-81ba3fa)
          image: retrogamehub/kong:sha-81ba3fa
    ...
    spec:
      containers:
        - name: backend
          ...
          image: retrogamehub/backend:sha-773b61c
          # La imagen se descarga solo si no existe localmente (mejor práctica)
          imagePullPolicy: IfNotPresent
          ports:
            - containerPort: 3000
