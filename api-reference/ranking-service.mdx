...
- 📊 Rankings globales multi-juego
- 🎮 Leaderboards por juego individual
- ⚡ Caché Redis para alta performance
...
Leaderboard de un juego específico.
...
Estadísticas y rankings del usuario.
