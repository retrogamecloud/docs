---
title: "8.1. Configuración de Entornos"
description: 'Referencia completa de configuración para todos los servicios de Retro Game Hub'
icon: "file-lines"
---

# ⚙️ Configuración del Sistema

Esta página documenta todas las variables de configuración, parámetros y ajustes disponibles en Retro Game Hub.
...
RATE_LIMIT_MAX_REQUESTS=10  # Máximo 10 requests/minuto
...
# Rangos válidos por juego (min,max)
...
El archivo `kong/kong.yml` define toda la configuración de Kong:
...
## 🎮 Configuración de js-dos

### Configuración por Juego

Cada juego tiene su configuración específica en la base de datos:
...
```javascript
// Log levels
logger.error('Error message');   // Errores críticos
...
# score-service deployment (más recursos por procesamiento)
resources:
  requests:
    memory: "256Mi"
    cpu: "200m"
...
## 🔧 Modificar Configuración en Producción
...
Para preguntas sobre configuración específica:
...
<Card title="Configuración Avanzada" icon="gear">
  ¿Necesitas configuración personalizada? Consulta nuestra documentación de servicios individuales o contacta al equipo de soporte.
</Card>
