---
title: 6.6. Route53 y Certificados SSL
sidebarTitle: 5.6. Route53 y SSL
...
<Warning>
  Para usar custom domain en CloudFront, el certificado ACM **debe estar en us-east-1** (región global de CloudFront, independiente de la región eu-west-1 del resto de recursos).
</Warning>
