...
El cluster EKS es el corazón de la infraestructura de RetroGame Cloud. Proporciona orquestación de contenedores, auto-escalado y alta disponibilidad.

## Especificaciones del Cluster

<CardGroup cols={2}>
  <Card title="Versión Kubernetes" icon="k">
    **v1.32**
...
<Steps>
  ...
  <Step title="Políticas de Escalado">
    - **Scale Up**: Cuando hay pods pendientes por >3 minutos
    - **Scale Down**: Cuando un nodo tiene <50% de utilización por >10 minutos
