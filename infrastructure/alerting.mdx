---
title: 4.5 Monitorización y Observabilidad
description: 'Stack completo de observabilidad para RetroGameCloud: métricas, logs,
  alertas y dashboards'
icon: chart-line
---

# 4.5 Monitorización y Observabilidad
...
## 4.5.2 Métricas de Negocio por Servicio
...
catalog_index_size:
  description: "Tamaño del índice de búsqueda"
  type: "gauge"
...
- **Búsquedas sin resultados > 30%**: Posible problema con índice

- **Tiempo de descarga p95 > 30s**: Revisar ancho de banda

- **Procesamiento metadata p99 > 2min**: Optimizar pipeline

- **Tamaño índice crecimiento > 50%/semana**: Revisar estrategia de limpieza
</Tab>
</Tabs>
...
game_session_duration:
  description: "Duración de sesiones de juego"
  type: "histogram"
...
- **Duración media < 5min**: Posibles problemas de experiencia
...
## 4.5.3 Configuración de Prometheus

<Tabs>
<Tab title="Configuración Principal">
...
<Card title="Métricas de Sistema" icon="server">
...
### 4.5.4.2 Dashboard de Aplicación

<Card title="Métricas de Negocio" icon="gamepad-2">
...
## 4.5.5 Configuración de Alertas
...
<Tab title="Plantillas de Notificación">
...
- Notificación Slack al canal #alerts

- Email a equipo de desarrollo

* *Nivel 2 - Critical (15-30 min)**

- Llamada automática al on-call engineer

- Notificación a gerencia técnica

- Activación de runbooks automáticos

* *Nivel 3 - Emergency (30+ min)**

- Escalado a CTO

- Notificación a stakeholders de negocio
...
<Tabs>
<Tab title="Configuración de Logs">
