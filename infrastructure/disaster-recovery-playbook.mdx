---
title: Procedimientos de Recuperación Ante Desastres
...
<Tabs>
  ...
  <Tab title="Evaluación">
    ...
    2. Falta documentación de rollback parcial
    3. Mejorar playbook de comunicación

    ## Acciones Correctivas
    - Automatizar configuración Kong
    - Crear runbook de rollback
    - Revisar plan de comunicación
    ```
  </Tab>
</Tabs>
