...
Consultar el runbook específico de Redis en la sección de [Runbooks](/infrastructure/runbooks) para procedimientos detallados de recuperación de ElastiCache.