---
title: 4.1. Visión General de Infraestructura
sidebarTitle: 5.1. Visión General
...
### 4.1.4.2. Monitoreo y Visualización
...
| **Total** | **$362-512** | Estimación mensual |
...
- **[4.2. Terraform Bootstrap](./terraform-bootstrap)**: Inicialización de Terraform

- **[4.3. Cluster EKS](./eks-cluster)**: Configuración del cluster Kubernetes

- **[4.4. Networking](./networking)**: Configuración de red y VPC

- **[4.5. Monitoreo](./monitoring)**: Setup de monitoreo y alertas

- **[4.6. Seguridad](./oauth2-authentication)**: Autenticación OAuth2 y seguridad