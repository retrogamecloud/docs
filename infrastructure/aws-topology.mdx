...
graph TB
    ...
    subgraph Region[🌍 us-east-1 Virginia]
        subgraph VPC[🏢 VPC RetroGameCloud<br/>CIDR: 10.0.0.0/16]
            ...
            subgraph AZ1[📍 Availability Zone us-east-1a]
                ...
                subgraph DB1[💾 Database Subnet<br/>10.0.21.0/24]
                    RDS1[🗄️ RDS Primary<br/>PostgreSQL 14<br/>db.t3.medium]
                    REDIS1[⚡ ElastiCache Redis<br/>cache.t3.micro<br/>Primary Node]
                end
            end
            ...
            subgraph AZ2[📍 Availability Zone us-east-1b]
                ...
                subgraph DB2[💾 Database Subnet<br/>10.0.22.0/24]
                    RDS2[🗄️ RDS Replica<br/>PostgreSQL 14<br/>db.t3.medium]
                    REDIS2[⚡ ElastiCache Redis<br/>cache.t3.micro<br/>Replica Node]
                end
            end
                ...
                subgraph PRIV3[🔒 Private Subnet<br/>10.0.13.0/24]
                    subgraph EKS3[☸️ EKS Node Group 3<br/>t3.large instances]
                        subgraph PODS3[Pod Network]
                            ...
                            BATCH3[⚙️ Batch Jobs Pod]
                            MONITOR3[📊 Monitoring Pod]
                        end
                    end
                end

                subgraph STORAGE3[💽 Storage Subnet<br/>10.0.23.0/24]
                    EFS[📁 Elastic File System<br/>Game Assets Storage]
                end
            end

            subgraph EKS_CONTROL[☸️ EKS Control Plane]
                EKS_MASTER[EKS Master Nodes<br/>Managed by AWS]
                EKS_API[Kubernetes API Server]
                EKS_ETCD[etcd Cluster]
            end

            subgraph S3_ZONE[☁️ S3 Storage Services]
                S3_ASSETS[🎮 S3 Game Assets<br/>retrogame-assets]
                S3_BACKUP[💾 S3 Backups<br/>retrogame-backups]
                S3_LOGS[📝 S3 Logs<br/>retrogame-logs]
                S3_STATIC[🌐 S3 Static Web<br/>retrogame-web]
            end
    ...
    subgraph EXTERNAL[🔗 Servicios Externos]
        ...
        SOCIAL[📱 OAuth Providers<br/>Google, Discord]
    end
