...
sequenceDiagram
    ...
    Frontend->>Frontend: Validación básica<br/>(campos requeridos)
...
sequenceDiagram
    ...
    Frontend-->>Usuario: Mostrar página detalle
...
sequenceDiagram
    ...
    Usuario->>Frontend: Escribe en barra búsqueda
    ...
    alt Cache Hit (< 30 min)
        ...
        DB-->>GameService: Resultados búsqueda
...
sequenceDiagram
    ...
    Frontend-->>Usuario: Página con mensaje error<br/>y botón "Reintentar"
