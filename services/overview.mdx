...
<div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
  <div className="flex items-center mb-2">
    <span className="font-semibold text-blue-800">🔐 Servicio Crítico</span>
  </div>
  <p className="text-blue-700">Servicio esencial para toda la plataforma. Requiere máxima disponibilidad.</p>
</div>
...
<div className="bg-green-50 border-l-4 border-green-400 p-4 mb-4">
  <div className="flex items-center mb-2">
    <span className="font-semibold text-green-800">👤 Servicio Principal</span>
  </div>
  <p className="text-green-700">Gestión de perfiles y datos de usuario. Alta demanda de lectura.</p>
</div>
...
<div className="bg-purple-50 border-l-4 border-purple-400 p-4 mb-4">
  <div className="flex items-center mb-2">
    <span className="font-semibold text-purple-800">🎮 Servicio Principal</span>
  </div>
  <p className="text-purple-700">Catálogo de juegos con assets pesados. Optimizado para cache.</p>
</div>
...
<div className="bg-orange-50 border-l-4 border-orange-400 p-4 mb-4">
  <div className="flex items-center mb-2">
    <span className="font-semibold text-orange-800">🏆 Servicio Secundario</span>
  </div>
...
<div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
  <div className="flex items-center mb-2">
    <span className="font-semibold text-yellow-800">📊 Servicio Secundario</span>
  </div>
  <p className="text-yellow-700">Cálculos de rankings. Procesamiento batch y consultas complejas.</p>
</div>
