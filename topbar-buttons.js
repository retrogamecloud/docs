  ...
  function addCustomButtons() {
    ...
    function createButtons(isMobile = false) {
      ...
      if (isMobile) {
        ...
        playBtn.style.cssText = 'background: linear-gradient(135deg, #00ff88 0%, #00aa55 100%); padding: 0; min-width: 28px; min-height: 28px;';
        playBtn.innerHTML = `
    ...
    if (mobileContainer && searchBarMobile) {
      ...
      mobileButtons.className = 'flex items-center gap-1 mr-1'; // Reduce gap
