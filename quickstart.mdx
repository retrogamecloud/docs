---
title: "1.1.1. Inicio Rápido"
description: "Despliega RetroGame Cloud en AWS en menos de 30 minutos"
icon: "rocket"
---
...
<Steps>
  ...
  <Step title="Configurar Variables">
    ...
    # Node Group (IMPORTANTE: mínimo t3.small)
...
<AccordionGroup>
  <Accordion icon="exclamation-triangle" title="Pods en estado Pending">
    ...
    **Solución**: Usar mínimo `t3.small` (2GB RAM, 11 pods/nodo)
  </Accordion>
