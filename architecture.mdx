...
description: "Visión general de la arquitectura de microservicios cloud-native de Retro Game Hub desplegada en AWS EKS, incluyendo decisiones arquitectónicas, infraestructura y justificaciones técnicas"
icon: file-lines
---
        ...
        subgraph "VPC: 10.0.0.0/16"
            subgraph "Public Subnets"
                ...
                subgraph "AZ-1c: 10.0.3.0/24"
                    NAT3[🔄 NAT Gateway<br/>Outbound Internet]
                end
            end
            ...
            subgraph "Private Subnets - Data Tier"
                subgraph "Data-AZ-1a: 10.0.100.0/24"
                    RDS1[🗄️ RDS Aurora PostgreSQL<br/>Primary Instance<br/>db.r5.large]
                    REDIS1[🚀 ElastiCache Redis<br/>Primary Node<br/>cache.r6g.large]
                end

                subgraph "Data-AZ-1b: 10.0.200.0/24"
                    RDS2[🗄️ RDS Aurora PostgreSQL<br/>Reader Replica<br/>db.r5.large]
                    REDIS2[🚀 ElastiCache Redis<br/>Replica Node<br/>cache.r6g.large]
                end

                subgraph "Data-AZ-1c: 10.0.300.0/24"
                    RDS3[🗄️ RDS Aurora PostgreSQL<br/>Reader Replica<br/>db.r5.large]
                    REDIS3[🚀 ElastiCache Redis<br/>Replica Node<br/>cache.r6g.large]
                end
            end

            subgraph "EKS Control Plane"
                EKSCP[☸️ EKS Control Plane<br/>Multi-AZ Managed<br/>API Server, etcd, Scheduler]
            end

            subgraph "Supporting Services"
                S3[🪣 S3 Buckets<br/>Game Files Storage<br/>Static Assets]
...
- **Amazon Aurora PostgreSQL**:
  ...
  - Automatic failover en <30 segundos
