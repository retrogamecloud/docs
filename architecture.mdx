...
description: "Visión general de la arquitectura de microservicios de Retro Game Hub"
---

## Visión General de la Arquitectura

Retro Game Hub está construido usando una arquitectura de microservicios cloud-native desplegada en AWS EKS (Kubernetes).
