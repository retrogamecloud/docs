...
description: Guía de resolución de problemas comunes en Retro Game Hub para desarrollo y producción
icon: file-lines
---

# 🔧 Troubleshooting

Guía completa para diagnosticar y resolver problemas comunes en Retro Game Hub en entornos de desarrollo y producción.
...
#### Síntomas
- Pods terminan con código de salida 137
...
- Usuario no puede completar autenticación

#### Diagnóstico
```bash
# Verificar configuración OAuth en GitHub
...
**B. Verificar configuración de sesiones**
```javascript
...
- **Grafana**: Métricas de infraestructura y aplicación
- **AWS CloudWatch**: Logs centralizados y métricas de AWS
- **RDS Performance Insights**: Análisis detallado de queries
- **Kong Manager**: Estado y métricas del API Gateway
...
1. **Recopilar información**: logs, métricas, timeline del problema
2. **Verificar status pages**: GitHub Status, AWS Status
3. **Contactar al equipo de DevOps** con toda la información relevante
