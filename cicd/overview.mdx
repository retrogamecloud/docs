...
description: Pipeline completo de integración y despliegue continuo con GitHub Actions, Docker, ECR y ArgoCD
icon: rocket
---
...
graph TB
    ...
    subgraph CD["🚀 CONTINUOUS DEPLOYMENT - ArgoCD"]
        ...
        Y -->|✅ Healthy| Z[Deployment Complete]
        Y -->|❌ Failed| AA[Automatic Rollback]
